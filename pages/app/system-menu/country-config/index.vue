<template>
    <div>
        <div class="d-flex flex-column-fluid">
            <div class="d-flex justify-content-center align-items-center m-20 w-100" v-if="$apollo.queries.GetAllCountries.loading">
                <div class="spinner spinner-primary spinner-lg mr-15"></div>
            </div>
            <div class=" container-fluid " v-if="!$apollo.queries.GetAllCountries.loading">
                <div class="subheader py-2 py-lg-4  subheader-transparent " id="kt_subheader">
                    <div class="d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap w-100">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-2">
                            ...
                            <!--begin::Title-->
                            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Country Configurations</h5>
                            <!--end::Title-->
                            ...
                            <div class="d-flex align-items-center" id="kt_subheader_search">
                                <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{GetAllCountries.length}}</span>
                                <div class="ml-5">
