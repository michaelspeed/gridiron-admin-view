<template>
  <div class="sidebar sidebar-left d-flex flex-row-auto flex-column " id="kt_sidebar">
    ...
    <div class="sidebar-content flex-column-fluid pb-10 pt-9 px-5 px-lg-10">
      <!--Title Widget-->
      <div class="d-flex justify-content-center align-items-center m-20" v-if="store === undefined || store === null">
        <div class="spinner spinner-primary spinner-lg mr-15"></div>
      </div>
      <div v-if="!(store === undefined || store === null)" class="card card-custom bgi-no-repeat gutter-b" style="height: 250px; background-color: #1B283F; background-position: calc(100% + 0.5rem) calc(100% + 0.5rem); background-size: 100% auto; background-image: url(/media/svg/patterns/rhone-2.svg)">
        <!--begin::Body-->
        <div class="card-body">
