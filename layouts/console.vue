                                        ...
                                        <ul class="navi navi-hover navi-active navi-accent" v-if="!menitem.subs">
                                            <li class="navi-item">
                                                <a class="navi-link" href="javascript:;"
                                                   @click="$router.push(menitem.to)">
                                                    <span class="navi-icon">
                                                        <span class="svg-icon svg-icon-primary svg-icon-2x mr-3">&lt;!&ndash;begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo6\dist/../src/media/svg/icons\General\Settings-1.svg&ndash;&gt;<svg
                                            ...
                                            <li class="navi-item" v-for="(subitem) of menitem.subs" :key="subitem.id">
                                                <a class="navi-link" href="javascript:;"
                                                   @click="$router.push(subitem.to)">
                                                    <span class="navi-icon">
                                                        <span class="svg-icon svg-icon-primary svg-icon-2x mr-3">&lt;!&ndash;begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo6\dist/../src/media/svg/icons\Shopping\Sort1.svg&ndash;&gt;<svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                            height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
