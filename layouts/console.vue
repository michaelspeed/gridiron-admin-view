      ...
      <div id="kt_header_mobile" class="header-mobile  header-mobile-fixed ">
        ...
        <div class="d-flex align-items-center">
          ...
          <button class="btn btn-hover-icon-primary p-0 ml-5" id="kt_sidebar_mobile_toggle">
				<span class="svg-icon svg-icon-xl"><!--begin::Svg Icon | path:assets/media/svg/icons/Design/Substract.svg--><svg
          ...
          <div class="aside aside-left d-flex flex-column " id="kt_aside">
            ...
            <div class="aside-brand d-flex flex-column align-items-center flex-column-auto pt-5 pt-lg-18 pb-10">
              ...
              <div class="btn p-0 symbol symbol-60 symbol-light-primary" href="?page=index" id="kt_quick_user_toggle">
                <div class="symbol-label ">
                  <img alt="Logo" src="/media/svg/avatars/001-boy.svg" class="h-75 align-self-end"/>
                </div>
              </div>
              <!--end::Logo-->
            </div>
            ...
            <div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pb-10">
              ...
              <ul class="nav flex-column">
                <!--begin::Item-->
                <a-tooltip placement="right" v-for="(menitem, index) of menu" :key="index">
                  <template slot="title">
                    {{$t(`${menitem.label}`)}}
                  </template>
                  <li class="nav-item mb-2">
                    <a href="javascript:;" @click="onClickMenu(menitem)" class="nav-link btn btn-icon btn-hover-text-primary btn-lg active">
            ...
            <div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-8">
              ...
              <a href="#" class="btn btn-icon btn-hover-text-primary btn-lg mb-1" id="kt_quick_panel_toggle"
                 ...
                 title="Quick Panel">
				<span class="svg-icon svg-icon-xxl"><!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg--><svg
          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
          viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
          ...
          fill="#000000" fill-rule="nonzero"/>
                ...
                <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                  <a href="#" class="btn btn-icon btn-light-info ml-3 h-40px w-40px flex-shrink-0"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" x="3" y="13" width="3" height="7" rx="1.5"/>
                ...
                <div class="dropdown dropdown-inline" data-toggle="tooltip" title="More links" data-placement="left">
                  <a href="#" class="btn btn-icon btn-light-danger ml-3 h-40px w-40px flex-shrink-0"
                     data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-vertical.svg--><svg
                      xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                      height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
            ...
            <div class="sidebar-content flex-column-fluid pb-10 pt-9 px-5 px-lg-10">
              ...
              <div class="card card-custom bg-light-success card-shadowless gutter-b">
                ...
                <div class="card-body my-3">
                  ...
                  <div class="font-weight-bold text-muted font-size-sm"><span
                    class="text-dark-75 font-size-h2 font-weight-bolder mr-2">67%</span>Average
                  </div>

                  <div class="progress progress-xs mt-7 bg-success-o-60">
                    <div class="progress-bar bg-success" role="progressbar" style="width: 67%;" aria-valuenow="50"
              ...
              <div class="card card-custom bg-light-warning card-shadowless gutter-b">
                ...
                <div class="card-body my-4">
                  ...
                  <div class="font-weight-bold text-muted font-size-sm"><span
                    class="text-dark-75 font-weight-bolder font-size-h2 mr-2">87K%</span>23k to goal
                  </div>

                  <div class="progress progress-xs mt-7 bg-warning-o-60">
                    <div class="progress-bar bg-warning" role="progressbar" style="width: 87%;" aria-valuenow="50"
                         aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
                <!--end::Body-->
