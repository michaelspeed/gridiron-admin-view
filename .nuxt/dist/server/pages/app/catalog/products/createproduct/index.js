...
module.exports.__inject__ = function (context) {
  add("40a9cbd7", content, true, context)
};
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".v-dialog__content{z-index:100000!important}.v-sheet{border-radius:0}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/catalog/products/createproduct/index.vue?vue&type=template&id=f7b3a56c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"d-flex flex-column-fluid\">","</div>",[_vm._ssrNode("<div class=\" container-fluid \">","</div>",[_vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-header border-0 justify-content-between align-items-center\"><h3 class=\"card-title align-items-start flex-column\"><span class=\"card-label font-weight-bolder text-dark\">Create Product</span></h3></div> "),_vm._ssrNode("<div class=\"card-body\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-md-8\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Product Name</label> "),_c('a-input',{model:{value:(_vm.name),callback:function ($$v) {_vm.name=$$v},expression:"name"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Slug</label> "),_c('a-input',{attrs:{"disabled":""},model:{value:(_vm.slug),callback:function ($$v) {_vm.slug=$$v},expression:"slug"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Facets</label> "),_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<a href=\"javascript:;\" class=\"btn btn-sm btn-light-success\"><i class=\"fas fa-plus\"></i> Add Facet\n                                    </a> "),_c('v-dialog',{attrs:{"scrollable":"","max-width":"300px"},model:{value:(_vm.addFacet),callback:function ($$v) {_vm.addFacet=$$v},expression:"addFacet"}},[_c('v-card',[_c('v-card-title',[_vm._v("Select Facet")]),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-card-text',{staticStyle:{"height":"300px"}},[_c('v-list',{staticStyle:{"margin-left":"10px","margin-right":"10px"},attrs:{"dense":""}},[_c('v-list-item-group',{attrs:{"color":"primary"}},[_c('v-text-field',{attrs:{"label":"Search","clearable":"","solo":""},model:{value:(_vm.facetSearch),callback:function ($$v) {_vm.facetSearch=$$v},expression:"facetSearch"}}),_vm._v(" "),_vm._l((_vm.allFacets),function(items){return _c('v-list-item',{key:items.id,on:{"click":function($event){return _vm.onClickSelect(items)}}},[_c('v-list-item-content',[(!_vm.onSelectTrace(items))?_c('span',{staticClass:"label label-inline"},[_vm._v("\n                                  "+_vm._s(items.facet.name.toUpperCase())+" "+_vm._s(items.code)+"\n                                ")]):_vm._e(),_vm._v(" "),(_vm.onSelectTrace(items))?_c('span',{staticClass:"label label-info label-inline mr-2"},[_vm._v("\n                                  "+_vm._s(items.facet.name.toUpperCase())+" "+_vm._s(items.code)+"\n                                ")]):_vm._e()])],1)})],2)],1)],1),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-card-actions',[_c('a',{staticClass:"btn btn-sm btn-light-success",attrs:{"href":"javascript:;"},on:{"click":function($event){_vm.addFacet = false}}},[_vm._v("\n                                                    close\n                                                ")])])],1)],1)],2),_vm._ssrNode(" <hr style=\"margin-top: 4px; margin-bottom: 4px\"> "),_vm._ssrNode("<div>","</div>",_vm._l((_vm.selectedFacet),function(ites){return _c('v-chip',{key:ites.id,staticClass:"ma-2",staticStyle:{"margin":"3px"},attrs:{"color":"#1b55e3","outlined":"","pill":"","small":""}},[_vm._v("\n                                        "+_vm._s(ites.facet.name.toUpperCase())+" "+_vm._s(ites.code)+"\n                                    ")])}),1),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2)],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-4\">","</div>",[_c('v-card',[_c('v-img',{attrs:{"contain":true,"src":_vm.featuredAssets === null ? 'https://via.placeholder.com/200' : (_vm.assetUrl + "/" + (_vm.featuredAssets.preview)),"height":"200px"}}),_vm._v(" "),_c('v-card-title',[_vm._v("\n                                    Assets\n                                ")]),_vm._v(" "),_c('v-card-actions',[_c('a',{staticClass:"btn btn-sm btn-light-success",attrs:{"href":"javascript:;"},on:{"click":function($event){_vm.addAsset = true}}},[_vm._v("\n                                        Add Asset\n                                    ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.showassets = !_vm.showassets}}},[_c('v-icon',[_vm._v(_vm._s(_vm.showassets ? 'mdi-chevron-up' : 'mdi-chevron-down'))])],1)],1),_vm._v(" "),_c('v-expand-transition',[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showassets),expression:"showassets"}],staticStyle:{"padding":"10px"}},[_c('v-divider'),_vm._v(" "),_c('v-row',_vm._l((_vm.selectedAssets),function(n){return _c('v-col',{key:n.id,staticClass:"d-flex child-flex",attrs:{"cols":"3"}},[_c('v-card',{staticClass:"d-flex",attrs:{"flat":"","tile":""},on:{"click":function($event){return _vm.onImageClicked($event, n)}}},[_c('v-img',{staticClass:"grey lighten-2",attrs:{"contain":true,"src":(_vm.assetUrl + "/" + (n.preview)),"aspect-ratio":"1"}})],1)],1)}),1)],1)])],1),_vm._ssrNode(" "),_c('v-menu',{attrs:{"position-x":_vm.x,"position-y":_vm.y,"absolute":"","offset-y":""},model:{value:(_vm.showMenu),callback:function ($$v) {_vm.showMenu=$$v},expression:"showMenu"}},[_c('v-list',[_c('v-list-item',[_c('v-list-item-title',[_vm._v("Preview")])],1),_vm._v(" "),_c('v-list-item',{attrs:{"disabled":_vm.featureActive},on:{"click":_vm.onSelectFeatured}},[_c('v-list-item-title',[_vm._v("Set as Featured")])],1),_vm._v(" "),_c('v-list-item',[_c('v-list-item-title',[_vm._v("Remove Asset")])],1)],1)],1)],2)],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Description</label> "),_c('client-only',[_c('editor',{attrs:{"api-key":"no-api-key","init":{
                        height: 500,
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/catalog/products/createproduct/index.vue?vue&type=script&lang=ts&
...
let createproductvue_type_script_lang_ts_Index = class Index extends external_vue_property_decorator_["Vue"] {
  constructor() {
    super(...arguments);
    this.name = "";
    this.slug = "";
  ...
  onCreateProduct() {
    ...
    this.$apollo.mutate({
      mutation: gql["B" /* CreateProductDocument */],
      variables: {
        name: this.name,
  ...
  onChangeName() {
    this.slug = Object(slugLoader["a" /* SlugLoader */])(this.name);
  }
...
__decorate([Object(external_vue_property_decorator_["Watch"])('name')], createproductvue_type_script_lang_ts_Index.prototype, "onChangeName", null);

__decorate([Object(external_vue_property_decorator_["Watch"])('facetValues')], createproductvue_type_script_lang_ts_Index.prototype, "onChangeFacetValue", null);

__decorate([Object(external_vue_property_decorator_["Watch"])('assets')], createproductvue_type_script_lang_ts_Index.prototype, "onChangeAssets", null);

createproductvue_type_script_lang_ts_Index = __decorate([Object(external_vue_property_decorator_["Component"])({
  layout: 'console',
  components: {
    'editor': ts_default.a
  },
...
})], createproductvue_type_script_lang_ts_Index);
/* harmony default export */ var createproductvue_type_script_lang_ts_ = (createproductvue_type_script_lang_ts_Index);
// CONCATENATED MODULE: ./pages/app/catalog/products/createproduct/index.vue?vue&type=script&lang=ts&
 /* harmony default export */ var products_createproductvue_type_script_lang_ts_ = (createproductvue_type_script_lang_ts_); 
...
// CONCATENATED MODULE: ./pages/app/catalog/products/createproduct/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  products_createproductvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardText: components_VCard["c" /* VCardText */],VCardTitle: components_VCard["d" /* VCardTitle */],VChip: VChip["a" /* default */],VCol: VCol["a" /* default */],VDialog: VDialog["a" /* default */],VDivider: VDivider["a" /* default */],VExpandTransition: transitions["a" /* VExpandTransition */],VIcon: VIcon["a" /* default */],VImg: VImg["a" /* default */],VList: VList["a" /* default */],VListItem: VListItem["a" /* default */],VListItemContent: components_VList["a" /* VListItemContent */],VListItemGroup: VListItemGroup["a" /* default */],VListItemTitle: components_VList["c" /* VListItemTitle */],VMenu: VMenu["a" /* default */],VProgressCircular: VProgressCircular["a" /* default */],VRow: VRow["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */]})
