...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/catalog/products/variants/specs/_id.vue?vue&type=template&id=5cef5de9&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"d-flex flex-column-fluid"},[_vm._ssrNode("<div class=\" container-fluid \">","</div>",[(_vm.productVariant !== undefined)?_vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-header border-0 d-flex justify-content-between align-items-center\"><h3 class=\"card-title align-items-start flex-column\"><a href=\"javascript:;\"><i class=\"fas fa-arrow-left font-size-h3 text-primary\"></i></a> <span class=\"card-label font-weight-bolder text-dark ml-6\">"+_vm._ssrEscape("Specs for: "+_vm._s(_vm.productVariant.name))+"</span></h3> <div class=\"card-toolbar\"><a href=\"#\" class=\"btn btn-light-primary font-weight-bolder font-size-sm\">Save</a> <a href=\"#\" class=\"btn btn-light-primary font-weight-bolder font-size-sm\">Add Specs Group</a></div></div> "),_vm._ssrNode("<div class=\"card-body\">","</div>",[_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div style=\"overflow-y: auto\">","</div>",_vm._l((_vm.master),function(group,index){return _vm._ssrNode("<div>","</div>",[_c('v-text-field',{attrs:{"label":"Group","filled":""},model:{value:(group.header),callback:function ($$v) {_vm.$set(group, "header", $$v)},expression:"group.header"}}),_vm._ssrNode(" <div style=\"margin-bottom: 5px\"><a href=\"#\" class=\"btn btn-light-primary font-weight-bolder font-size-sm\">Add Specs</a></div> "),_vm._ssrNode("<div>","</div>",_vm._l((group.child),function(spec,specindex){return _vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div class=\"d-flex justify-content-between align-items-center gutter\">","</div>",[_c('v-text-field',{staticStyle:{"margin-right":"10px"},attrs:{"label":"Key","filled":"","dense":""},model:{value:(spec.key),callback:function ($$v) {_vm.$set(spec, "key", $$v)},expression:"spec.key"}}),_vm._ssrNode(" "),_c('v-text-field',{staticStyle:{"margin-left":"10px"},attrs:{"label":"Value","filled":"","dense":""},model:{value:(spec.value),callback:function ($$v) {_vm.$set(spec, "value", $$v)},expression:"spec.value"}})],2)])}),0)],2)}),0)])])])],2):_vm._e()])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/app/catalog/products/variants/specs/_id.vue?vue&type=template&id=5cef5de9&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/catalog/products/variants/specs/_id.vue?vue&type=script&lang=ts&
...
let _idvue_type_script_lang_ts_ProductSpecification = class ProductSpecification extends external_vue_property_decorator_["Vue"] {
  constructor() {
    super(...arguments);
    this.specsId = '';
    this.master = [];
  ...
  onSave() {
    if (this.specsId !== '') {
      this.$apollo.mutate({
        mutation: gql["Vc" /* UpdateProductVariantSpecificationDocument */],
        variables: {
          id: this.specsId,
          specs: this.master
        }
      ...
      this.$apollo.mutate({
        mutation: gql["E" /* CreateProductVariantSpecificationDocument */],
        variables: {
...
__decorate([Object(external_vue_property_decorator_["Watch"])('productVariant')], _idvue_type_script_lang_ts_ProductSpecification.prototype, "onProdVariant", null);

_idvue_type_script_lang_ts_ProductSpecification = __decorate([Object(external_vue_property_decorator_["Component"])({
  layout: 'console',
  apollo: {
    productVariant: {
      query: gql["Zb" /* GetSingleProductVariantDocument */],
...
})], _idvue_type_script_lang_ts_ProductSpecification);
/* harmony default export */ var _idvue_type_script_lang_ts_ = (_idvue_type_script_lang_ts_ProductSpecification);
// CONCATENATED MODULE: ./pages/app/catalog/products/variants/specs/_id.vue?vue&type=script&lang=ts&
 /* harmony default export */ var specs_idvue_type_script_lang_ts_ = (_idvue_type_script_lang_ts_); 
...
// CONCATENATED MODULE: ./pages/app/catalog/products/variants/specs/_id.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  specs_idvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
