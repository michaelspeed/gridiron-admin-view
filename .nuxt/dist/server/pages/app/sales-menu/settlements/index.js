...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/sales-menu/settlements/index.vue?vue&type=template&id=2708a985&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"d-flex flex-column-fluid\">","</div>",[_vm._ssrNode("<div class=\" container-fluid \">","</div>",[_vm._ssrNode("<div id=\"kt_subheader\" class=\"subheader py-2 py-lg-4  subheader-transparent \"><div class=\"d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap w-100\"><div class=\"d-flex align-items-center flex-wrap mr-2\"><h5 class=\"text-dark font-weight-bold mt-2 mb-2 mr-5\">Shipment</h5> <div class=\"subheader-separator subheader-separator-ver mt-2 mb-2 mr-5 bg-gray-200\"></div> <div id=\"kt_subheader_search\" class=\"d-flex align-items-center\"><span id=\"kt_subheader_total\" class=\"text-dark-50 font-weight-bold\"></span></div></div> <div class=\"d-flex align-items-center\"><a href=\"#\"></a></div></div></div> "+((_vm.$apollo.queries.settlements.loading)?("<div class=\"d-flex justify-content-center align-items-center m-20 w-100\"><div class=\"spinner spinner-primary spinner-lg mr-15\"></div></div>"):"<!---->")+" "),_vm._ssrNode("<div class=\"card\">","</div>",[(!_vm.$apollo.queries.settlements.loading)?_vm._ssrNode("<div class=\"card-body pt-0\">","</div>",[_vm._ssrNode("<div class=\"table-responsive\">","</div>",[_vm._ssrNode("<table id=\"kt_advance_table_widget_1\" class=\"table table-head-custom table-vertical-center\">","</table>",[_vm._ssrNode("<thead><tr class=\"text-left\"><th style=\"min-width: 200px\">Date</th> <th style=\"min-width: 150px\">Status</th> <th style=\"min-width: 150px\">progress</th> <th>Action</th></tr></thead> "),_vm._ssrNode("<tbody>","</tbody>",_vm._l((_vm.settlements),function(settle){return _vm._ssrNode("<tr>","</tr>",[_vm._ssrNode("<td class=\"pl-0\"><a href=\"#\" class=\"text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg\">"+_vm._ssrEscape(_vm._s(_vm.getDate(settle.createdAt)))+"</a> <span class=\"text-muted font-weight-bold text-muted d-block\">"+_vm._ssrEscape(_vm._s(settle.amount)+" INR")+"</span></td> <td><span class=\"text-dark-75 font-weight-bolder d-block font-size-lg\">"+_vm._ssrEscape("\n                            "+_vm._s(settle.type)+"\n                        ")+"</span></td> "),_vm._ssrNode("<td>","</td>",[_c('ProgressIndicator',{attrs:{"percentage":_vm.calculatePercentage(settle)}})],1),_vm._ssrNode(" "),_vm._ssrNode("<td>","</td>",[_c('VendorSettlementAction',{attrs:{"settle":settle,"header":true}})],1)],2)}),0)],2)])]):_vm._e()])],2)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/app/sales-menu/settlements/index.vue?vue&type=template&id=2708a985&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/sales-menu/settlements/index.vue?vue&type=script&lang=ts&
var __decorate = undefined && undefined.__decorate || function (decorators, target, key, desc) {
  var c = arguments.length,
      r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc,
      d;
...
let settlementsvue_type_script_lang_ts_SettlementsView = class SettlementsView extends external_vue_property_decorator_["Vue"] {
  constructor() {
    super(...arguments);
    this.limit = 50;
    this.offset = 0;
...
settlementsvue_type_script_lang_ts_SettlementsView = __decorate([Object(external_vue_property_decorator_["Component"])({
  layout: 'console',
  components: {
  ...
  apollo: {
    settlements: {
      query: gql["ib" /* GetAllSettlementDocument */],
...
})], settlementsvue_type_script_lang_ts_SettlementsView);
/* harmony default export */ var settlementsvue_type_script_lang_ts_ = (settlementsvue_type_script_lang_ts_SettlementsView);
// CONCATENATED MODULE: ./pages/app/sales-menu/settlements/index.vue?vue&type=script&lang=ts&
 /* harmony default export */ var sales_menu_settlementsvue_type_script_lang_ts_ = (settlementsvue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(4);

// CONCATENATED MODULE: ./pages/app/sales-menu/settlements/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  sales_menu_settlementsvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var settlements = __webpack_exports__["default"] = (component.exports);
