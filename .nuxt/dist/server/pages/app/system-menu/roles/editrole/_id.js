...
var VAutocomplete = __webpack_require__(296);
...
/* harmony default export */ var VAutocomplete_VAutocomplete = (VSelect["a" /* default */].extend({
  ...
  methods: {
    ...
    changeSelectedIndex(keyCode) {
      ...
      if (this.multiple && keyCode === helpers["r" /* keyCodes */].left) {
        if (this.selectedIndex === -1) {
          this.selectedIndex = this.selectedItems.length - 1;
        } else {
          this.selectedIndex--;
        }
      } else if (this.multiple && keyCode === helpers["r" /* keyCodes */].right) {
        if (this.selectedIndex >= this.selectedItems.length - 1) {
          this.selectedIndex = -1;
        } else {
          this.selectedIndex++;
        }
      } else if (keyCode === helpers["r" /* keyCodes */].backspace || keyCode === helpers["r" /* keyCodes */].delete) {
...
/* harmony default export */ var VCombobox = __webpack_exports__["a"] = (VAutocomplete_VAutocomplete.extend({
  ...
  methods: {
    ...
    onKeyDown(e) {
      ...
      if (this.multiple && keyCode === helpers["r" /* keyCodes */].left && this.$refs.input.selectionStart === 0) {
        this.updateSelf();
      } else if (keyCode === helpers["r" /* keyCodes */].enter) {
        this.onEnterDown(e);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/system-menu/roles/editrole/_id.vue?vue&type=template&id=1861fb94&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"d-flex flex-column-fluid\">","</div>",[_vm._ssrNode("<div class=\" container-fluid \">","</div>",[_vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-header border-0 py-5\"><h3 class=\"card-title align-items-start flex-column\"><span class=\"card-label font-weight-bolder text-dark\">Edit Role</span></h3></div> "),_vm._ssrNode("<div class=\"card-body\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Code</label> "),_c('a-input',{attrs:{"disabled":true},model:{value:(_vm.code),callback:function ($$v) {_vm.code=$$v},expression:"code"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Description</label> "),_c('a-input',{attrs:{"type":"textarea"},model:{value:(_vm.desc),callback:function ($$v) {_vm.desc=$$v},expression:"desc"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Roles</label> "),_c('v-combobox',{attrs:{"items":_vm.permMenu,"chips":"","clearable":"","label":"Roles","multiple":"","solo":"","color":"primary"},scopedSlots:_vm._u([{key:"selection",fn:function(ref){
var attrs = ref.attrs;
var item = ref.item;
var select = ref.select;
var selected = ref.selected;
return [_c('v-chip',_vm._b({attrs:{"input-value":selected,"close":"","color":"primary","outlined":true},on:{"click":select,"click:close":function($event){return _vm.remove(item)}}},'v-chip',attrs,false),[_c('strong',[_vm._v(_vm._s(item.toUpperCase()))])])]}}]),model:{value:(_vm.permission),callback:function ($$v) {_vm.permission=$$v},expression:"permission"}})],2),_vm._ssrNode(" <div><button type=\"button\" class=\"btn btn-light-primary\">Update Role</button> <button type=\"button\" class=\"btn btn-light-danger\">Back</button></div>")],2)],2)])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/app/system-menu/roles/editrole/_id.vue?vue&type=template&id=1861fb94&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/system-menu/roles/editrole/_id.vue?vue&type=script&lang=ts&
...
let _idvue_type_script_lang_ts_EditRole = class EditRole extends external_vue_property_decorator_["Vue"] {
  constructor() {
    super(...arguments);
    this.code = '';
    this.desc = '';
    this.permMenu = PermissionEnum["a" /* PermissionArray */];
    this.permission = [];
    this.loading = false;
  }
  ...
  onUpdateRole() {
    this.loading = true;
    this.$apollo.mutate({
      mutation: gql["Wc" /* UpdateRoleDocument */],
      variables: {
        id: this.$route.params.id,
...
__decorate([Object(external_vue_property_decorator_["Prop"])()], _idvue_type_script_lang_ts_EditRole.prototype, "id", void 0);

_idvue_type_script_lang_ts_EditRole = __decorate([Object(external_vue_property_decorator_["Component"])({
  layout: 'console'
})], _idvue_type_script_lang_ts_EditRole);
/* harmony default export */ var _idvue_type_script_lang_ts_ = (_idvue_type_script_lang_ts_EditRole);
// CONCATENATED MODULE: ./pages/app/system-menu/roles/editrole/_id.vue?vue&type=script&lang=ts&
 /* harmony default export */ var editrole_idvue_type_script_lang_ts_ = (_idvue_type_script_lang_ts_); 
...
var VCombobox = __webpack_require__(396);

// CONCATENATED MODULE: ./pages/app/system-menu/roles/editrole/_id.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  editrole_idvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents_default()(component, {VChip: VChip["a" /* default */],VCombobox: VCombobox["a" /* default */]})
