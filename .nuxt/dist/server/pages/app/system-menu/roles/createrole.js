...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/system-menu/roles/createrole.vue?vue&type=template&id=84624e3c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"d-flex flex-column-fluid\">","</div>",[_vm._ssrNode("<div class=\" container-fluid \">","</div>",[_vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-header border-0 py-5\"><h3 class=\"card-title align-items-start flex-column\"><span class=\"card-label font-weight-bolder text-dark\">Create Role</span></h3></div> "),_vm._ssrNode("<div class=\"card-body\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Code</label> "),_c('a-input',{model:{value:(_vm.code),callback:function ($$v) {_vm.code=$$v},expression:"code"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Description</label> "),_c('a-input',{attrs:{"type":"textarea"},model:{value:(_vm.desc),callback:function ($$v) {_vm.desc=$$v},expression:"desc"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>Roles</label> "),_c('v-combobox',{attrs:{"items":_vm.permMenu,"chips":"","clearable":"","label":"Roles","multiple":"","solo":"","color":"#3F51B5"},scopedSlots:_vm._u([{key:"selection",fn:function(ref){
var attrs = ref.attrs;
var item = ref.item;
var select = ref.select;
var selected = ref.selected;
return [_c('v-chip',_vm._b({attrs:{"input-value":selected,"close":"","color":"#3F51B5","outlined":true},on:{"click":select,"click:close":function($event){return _vm.remove(item)}}},'v-chip',attrs,false),[_c('strong',[_vm._v(_vm._s(item.toUpperCase()))])])]}}]),model:{value:(_vm.permission),callback:function ($$v) {_vm.permission=$$v},expression:"permission"}})],2),_vm._ssrNode(" <div><button type=\"button\" class=\"btn btn-light-primary\">Create Role</button></div>")],2)],2)])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/app/system-menu/roles/createrole.vue?vue&type=template&id=84624e3c&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/system-menu/roles/createrole.vue?vue&type=script&lang=ts&
...
let createrolevue_type_script_lang_ts_CreateRole = class CreateRole extends external_vue_property_decorator_["Vue"] {
  constructor() {
    super(...arguments);
    this.code = '';
    this.desc = '';
  ...
  onCreateRole() {
    this.loading = true;
    this.$apollo.mutate({
      mutation: gql["G" /* CreateRoleDocument */],
      variables: {
        code: this.code,
...
createrolevue_type_script_lang_ts_CreateRole = __decorate([Object(external_vue_property_decorator_["Component"])({
  layout: 'console'
})], createrolevue_type_script_lang_ts_CreateRole);
/* harmony default export */ var createrolevue_type_script_lang_ts_ = (createrolevue_type_script_lang_ts_CreateRole);
// CONCATENATED MODULE: ./pages/app/system-menu/roles/createrole.vue?vue&type=script&lang=ts&
 /* harmony default export */ var roles_createrolevue_type_script_lang_ts_ = (createrolevue_type_script_lang_ts_); 
...
// CONCATENATED MODULE: ./pages/app/system-menu/roles/createrole.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  roles_createrolevue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var createrole = __webpack_exports__["default"] = (component.exports);
