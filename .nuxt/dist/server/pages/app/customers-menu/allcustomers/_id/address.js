...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/customers-menu/allcustomers/_id/address.vue?vue&type=template&id=77c0fa96&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"card card-custom\">","</div>",[_vm._ssrNode("<div class=\"card-header py-3\"><div class=\"card-title align-items-start flex-column\"><h3 class=\"card-label font-weight-bolder text-dark\">Address Information</h3> <span class=\"text-muted font-weight-bold font-size-sm mt-1\">user addresses</span></div> <div class=\"card-toolbar\"></div></div> "),_vm._ssrNode("<form class=\"form\">","</form>",[_vm._ssrNode("<div class=\"card-body\">","</div>",_vm._l((_vm.user.addresses),function(add){return _c('v-card',{key:add.id,attrs:{"color":"primary","dark":""}},[_c('div',{staticClass:"d-flex flex-no-wrap justify-space-between"},[_c('div',[_c('v-card-title',{staticClass:"headline"},[_vm._v(_vm._s(add.fullName))]),_vm._v(" "),_c('v-card-subtitle',[_vm._v(_vm._s(add.addressLine))]),_vm._v(" "),_c('v-card-text',[_c('div',[_c('span',[_vm._v(_vm._s(add.landmark))])]),_vm._v(" "),_c('div',[_c('span',[_vm._v(_vm._s(add.city))])]),_vm._v(" "),_c('div',[_c('span',[_vm._v(_vm._s(add.state))])]),_vm._v(" "),_c('div',[_c('span',[_vm._v(_vm._s(add.postalCode))])]),_vm._v(" "),_c('div',[_c('span',[_vm._v(_vm._s(add.phoneNumber))])])])],1)])])}),1)])],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/app/customers-menu/allcustomers/_id/address.vue?vue&type=template&id=77c0fa96&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/customers-menu/allcustomers/_id/address.vue?vue&type=script&lang=ts&
...
let addressvue_type_script_lang_ts_AddressUser = class AddressUser extends external_vue_property_decorator_["Vue"] {};
addressvue_type_script_lang_ts_AddressUser = __decorate([Object(external_vue_property_decorator_["Component"])({
  layout: 'console',
  apollo: {
    user: {
...
})], addressvue_type_script_lang_ts_AddressUser);
/* harmony default export */ var addressvue_type_script_lang_ts_ = (addressvue_type_script_lang_ts_AddressUser);
// CONCATENATED MODULE: ./pages/app/customers-menu/allcustomers/_id/address.vue?vue&type=script&lang=ts&
 /* harmony default export */ var _id_addressvue_type_script_lang_ts_ = (addressvue_type_script_lang_ts_); 
...
// CONCATENATED MODULE: ./pages/app/customers-menu/allcustomers/_id/address.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _id_addressvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents_default()(component, {VCard: VCard["a" /* default */],VCardSubtitle: components_VCard["b" /* VCardSubtitle */],VCardText: components_VCard["c" /* VCardText */],VCardTitle: components_VCard["d" /* VCardTitle */]})
