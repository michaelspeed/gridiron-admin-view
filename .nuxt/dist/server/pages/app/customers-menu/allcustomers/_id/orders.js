...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/customers-menu/allcustomers/_id/orders.vue?vue&type=template&id=01f27418&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"card card-custom\">","</div>",[_vm._ssrNode("<div class=\"card-header py-3\"><div class=\"card-title align-items-start flex-column\"><h3 class=\"card-label font-weight-bolder text-dark\">Order Information</h3> <span class=\"text-muted font-weight-bold font-size-sm mt-1\">"+_vm._ssrEscape("Total Orders "+_vm._s(_vm.user.ordersAggregate.count.id))+"</span></div> <div class=\"card-toolbar\"></div></div> "),_vm._ssrNode("<div class=\"form\">","</div>",[_vm._ssrNode("<div class=\"card-body\">","</div>",_vm._l((_vm.user.orders),function(order){return _c('v-card',{key:order.id,staticClass:"mx-auto mt-5 mb-5",attrs:{"color":"secondary"}},[_c('v-card-title',{staticClass:"text-white"},[_vm._v(_vm._s(order.id))]),_vm._v(" "),_c('v-card-text',[_c('div',{staticClass:"subtitle-1 text-white-50"},[_vm._v("\n                            Total Items: "+_vm._s(order.lines.length)+"\n                        ")])]),_vm._v(" "),_c('v-card-title',{staticClass:"text-white"},[_vm._v("CreatedAt: "+_vm._s(_vm.getDate(order.createdAt)))]),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{attrs:{"color":"primary","text":""}},[_vm._v("\n                            View Order\n                        ")])],1)],1)}),1)])],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/app/customers-menu/allcustomers/_id/orders.vue?vue&type=template&id=01f27418&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/app/customers-menu/allcustomers/_id/orders.vue?vue&type=script&lang=ts&
...
let ordersvue_type_script_lang_ts_Orders = class Orders extends external_vue_property_decorator_["Vue"] {
  getDate(date) {
    return external_moment_default()(date).format('DD MMM YYYY HH:mm');
  }

};
ordersvue_type_script_lang_ts_Orders = __decorate([Object(external_vue_property_decorator_["Component"])({
  layout: 'console',
  apollo: {
    user: {
...
// CONCATENATED MODULE: ./pages/app/customers-menu/allcustomers/_id/orders.vue?vue&type=script&lang=ts&
 /* harmony default export */ var _id_ordersvue_type_script_lang_ts_ = (ordersvue_type_script_lang_ts_); 
...
// CONCATENATED MODULE: ./pages/app/customers-menu/allcustomers/_id/orders.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _id_ordersvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardText: components_VCard["c" /* VCardText */],VCardTitle: components_VCard["d" /* VCardTitle */]})
