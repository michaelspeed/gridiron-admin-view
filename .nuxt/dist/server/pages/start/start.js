...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/start/start.vue?vue&type=template&id=156042ed&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticStyle:{"height":"100vh","width":"100vw","background-image":"url(/media/error/bg3.jpg)"}},[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-body\">","</div>",[_vm._ssrNode("<div class=\"row\"><div class=\"col-md-6\"><a href=\"javascript: void(0);\"><img src=\"/master/logo/air.png\" alt=\"AirEcommerce\" style=\"height: 100px\"></a> <div><h5 class=\"mt-2 text-primary\">Welcome to Air-Ecommerce</h5></div></div></div> <hr> "),_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-md-6 col-lg-6 col-sm-12\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>"+_vm._ssrEscape(_vm._s(_vm.$t('store.storename')))+"</label> "),_c('a-input',{model:{value:(_vm.storename),callback:function ($$v) {_vm.storename=$$v},expression:"storename"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-6 col-lg-6 col-sm-12\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenumber')))+"</label> "),_c('a-input',{model:{value:(_vm.storenumber),callback:function ($$v) {_vm.storenumber=$$v},expression:"storenumber"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-6 col-lg-6 col-sm-12\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>"+_vm._ssrEscape(_vm._s(_vm.$t('store.storeemail')))+"</label> "),_c('a-input',{model:{value:(_vm.officialemail),callback:function ($$v) {_vm.officialemail=$$v},expression:"officialemail"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-6 col-lg-6 col-sm-12\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>"+_vm._ssrEscape(_vm._s(_vm.$t('store.storezipcode')))+"</label> "),_c('a-input',{model:{value:(_vm.zipcode),callback:function ($$v) {_vm.zipcode=$$v},expression:"zipcode"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-6 col-lg-6 col-sm-12\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>"+_vm._ssrEscape(_vm._s(_vm.$t('store.storeadd1')))+"</label> "),_c('a-input',{model:{value:(_vm.add1),callback:function ($$v) {_vm.add1=$$v},expression:"add1"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-6 col-lg-6 col-sm-12\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>"+_vm._ssrEscape(_vm._s(_vm.$t('store.storeadd2')))+"</label> "),_c('a-input',{model:{value:(_vm.add2),callback:function ($$v) {_vm.add2=$$v},expression:"add2"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-6 col-lg-6 col-sm-12\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>"+_vm._ssrEscape(_vm._s(_vm.$t('store.storegstin')))+"</label> "),_c('a-input',{model:{value:(_vm.gstin),callback:function ($$v) {_vm.gstin=$$v},expression:"gstin"}}),_vm._ssrNode(" <small class=\"form-text text-muted\">"+_vm._ssrEscape(_vm._s(_vm.$t('store.storenameinfo')))+"</small>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-6 col-lg-6 col-sm-12\">","</div>",[_vm._ssrNode("<div class=\"form-group\">","</div>",[_vm._ssrNode("<label>"+_vm._ssrEscape(_vm._s(_vm.$t('store.storecountry')))+"</label> "),_vm._ssrNode("<div>","</div>",[_c('a-select',{staticStyle:{"width":"100%"},attrs:{"filterable":"","placeholder":"Select Default Country"},model:{value:(_vm.country),callback:function ($$v) {_vm.country=$$v},expression:"country"}},_vm._l((_vm.allCountry),function(item){return _c('a-select-option',{key:item.id,attrs:{"show-search":"","value":item.id}},[_vm._v("\n                                            "+_vm._s(item.name)+"\n                                        ")])}),1)],1)],2)])],2)]),_vm._ssrNode(" "),_c('v-card-actions',[_c('a',{staticClass:"btn btn-light-primary btn-sm font-weight-bold mr-2",attrs:{"href":"javascript:;"},on:{"click":_vm.onCreateStore}},[_vm._v("Create Store")])])],2)])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/start/start.vue?vue&type=template&id=156042ed&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/start/start.vue?vue&type=script&lang=ts&
...
let startvue_type_script_lang_ts_DefaultStore = class DefaultStore extends external_vue_property_decorator_["Vue"] {
  constructor() {
    super(...arguments);
    this.storename = '';
    this.storenumber = '';
  ...
  onCreateStore() {
    this.$apollo.mutate({
      mutation: gql["i" /* CreateDefaultStoreDocument */],
      variables: {
...
__decorate([Object(external_vue_property_decorator_["Watch"])('GetAllCountries')], startvue_type_script_lang_ts_DefaultStore.prototype, "onLoadCountry", null);

startvue_type_script_lang_ts_DefaultStore = __decorate([Object(external_vue_property_decorator_["Component"])({
  layout: 'start',
  apollo: {
    GetAllCountries: {
...
})], startvue_type_script_lang_ts_DefaultStore);
/* harmony default export */ var startvue_type_script_lang_ts_ = (startvue_type_script_lang_ts_DefaultStore);
// CONCATENATED MODULE: ./pages/start/start.vue?vue&type=script&lang=ts&
 /* harmony default export */ var start_startvue_type_script_lang_ts_ = (startvue_type_script_lang_ts_); 
...
// CONCATENATED MODULE: ./pages/start/start.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  start_startvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents_default()(component, {VCardActions: VCard["a" /* VCardActions */]})
